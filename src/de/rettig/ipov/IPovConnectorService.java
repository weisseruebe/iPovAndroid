 ...
 */
public class IPovConnectorService {
    // Debugging
    private static final String TAG = "IPovConnectorsService";
    private static final boolean D = true;

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "IPovConnectorSecure";
     ...
     */
    public IPovConnectorService(Context context, Handler handler) {
    ...
    private void connectionFailed() {
        ...
        IPovConnectorService.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (IPovConnectorService.this) {
                        switch (mState) {
                        case STATE_LISTEN:
